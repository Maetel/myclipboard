...
- Before release, run TypeScript, frontend, static regression, macOS CLI installer, and native Rust tests. Never reintroduce macOS Keychain access for app session or local history encryption keys.
